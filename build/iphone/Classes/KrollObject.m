 ...
 * Copyright (c) 2009-2011 by WYN, Inc. All Rights Reserved.
...
//@interface WYNObject : NSObject
//@end

@interface WYNObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WYNObject class]])
		{
			for (NSString *key in [[(WYNObject*)o modules] allKeys])
			{
