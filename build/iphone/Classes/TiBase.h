...
// in simulator we redefine to format for WYN Developer console
...
{\
	NSString * exceptionName = [@"org.wyn." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wyn";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIWYNNativeItemNone = -1, 
	UIWYNNativeItemSpinner = -2,
	UIWYNNativeItemProgressBar = -3,
	
	UIWYNNativeItemSlider = -4,
	UIWYNNativeItemSwitch = -5,
	UIWYNNativeItemMultiButton = -6,
	UIWYNNativeItemSegmented = -7,
	
	UIWYNNativeItemTextView = -8,
	UIWYNNativeItemTextField = -9,
	UIWYNNativeItemSearchBar = -10,
	
	UIWYNNativeItemPicker = -11,
	UIWYNNativeItemDatePicker = -12,
	
	UIWYNNativeItemInfoLight = -13,
	UIWYNNativeItemInfoDark = -14,
	
	UIWYNNativeItemDisclosure = -15,
	
	UIWYNNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all WYN instances of
